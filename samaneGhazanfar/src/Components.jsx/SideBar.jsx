...
export const SideBar = ()=>{
    ...
    //  const [contactList , setContactList ] = useState ([])
     ...
     const fetchContacts = async()=>{
       const result = await farawin.getContacts((res)=>console.table(res))

    //     const showContact =result.contactList

    //   showContact.map((res)=>{console.table(res)})
    }
    fetchContacts()
    ...
    return(
        ...
        <div
        id="showContactList"
        className ="bg-[#4f4e4e] flex flex-col w-[300px] p-1 m-2 max-sm:hidden"
        >
