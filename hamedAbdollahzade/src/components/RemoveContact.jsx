...
export const RemoveContact = () => {
  ...
  return (
      <form className="flex flex-col justify-center bg-slate-700 rounded-2xl text-white h-[150px] w-full overflow-hidden my-1 p-6">
        ...
        <input type="tel" value={inputTel} onChange={(e)=>setInputTel(e.target.value)} className="rounded-full text-center text-black" />

        <button type="button" onClick={SendInformation} className="border my-4 rounded-full hover:bg-red-700">REMOVE</button>
