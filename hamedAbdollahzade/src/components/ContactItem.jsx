...
export const ContactItem = (prop) => {
  ...
  return (
    ...
    >
      <div
        className={"hover:bg-[rgba(28,62,156,0.2)]  flex flex-row h-14 w-full overflow-hidden rounded-lg my-1 relative"}
      >
        <div
          className={
            Math.random() * 1 > 0.4
        ...
        <div className="flex flex-col ">
          ...
          <p className="text-xs  text-start my-1 text-white">{prop.contact.username}</p>
        </div>
