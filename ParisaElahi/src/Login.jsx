...
export const Login = (props) => {
  ...
  const validForm = async () => {
    setIsLoading(true);
    const res = await farawin.testLogin(phone, pass);
    alert(res.message);
    console.log(res);
    if (res.code === "200") {
        ...
        <form className="bg-white w-[400px] h-[700px] rounded-xl flex flex-col p-10">
          ...
          <div className="mt-2" style={{ position: "relative" }}>
            <input
              ...
              className=" w-full cursor-pointer text-md border-b-[1.7px] pl-6 focus:outline-0"
            />
            <svg
          ...
          {/* پسوورد */}
          <label htmlFor="pass" className="m-1 mt-6 text-sm ">
            {" "}
            Password{" "}
          </label>
          ...
          <div className="text-sm text-gray-500 text-center my-32 mb-2">
            Or Sign Up Using
          </div>
          <button
