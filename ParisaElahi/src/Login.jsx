      ...
      return (
        ...
        >
          ...
          <button 
            ...
            <span className="text-sm text-gray-500 text-center m-2">Or Sign Up Using</span>
            ...
            <div className="text-sm text-gray-500 text-center my-32 mb-2">Or Sign Up Using</div>
            <button className="text-md mt-2" onClick={() => props.switchForm("Register")}>SIGN UP</button>
          </form>
        </div>
        </form>
      );
