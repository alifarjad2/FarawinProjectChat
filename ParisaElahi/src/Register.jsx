...
export const Register = (props) => {
  ...
  const validForm = async () => {
    const res = await farawin.testRegister(phone, pass, repassword);
    alert(res.message);
  };
    ...
    <form onSubmit={handleSubmit}>
      ...
      >
        ...
        <form className="bg-white w-[400px] h-[700px] rounded-xl flex flex-col p-10">
          <h1 className="font-bold text-center text-[2.5rem] h-4 m-2 mb-8">
            Register
          </h1>

          {/* یوزرنیم */}
          <label htmlFor="phoneNum" className=" m-1 mt-4 text-sm ">
            Username{" "}
          </label>
          ...
          <div className="mt-2" style={{ position: "relative" }}>
            ...
            <svg
              ...
              strokeWidth="2.5"
              stroke="currentColor"
              className=" text-gray-400 w-4 h-4 top-1 "
            >
              <path
                strokeLinecap="round"
            ...
            {phone.length != 0 && phone.length != 11 && (
              <p className="text-[12px] m-0 text-red-400">
                wrong Phone Number{" "}
              </p>
            )}
          </div>
          ...
          {/* پسوورد */}
          <label htmlFor="pass" className="m-1 mt-6 text-sm minLenght=8 ">
            {" "}
            Password{" "}
          </label>
          ...
          <div className="mt-2 block" style={{ position: "relative" }}>
            ...
            {pass.length != 0 && pass.length < 8 && (
              <p className="text-[12px] m-0 text-red-400">
                {" "}
                Password not too long, Enter atleast 8 characters{" "}
              </p>
            )}
          </div>
          {/* پسوورد مجدد */}
          ...
          <div className="mt-2 block" style={{ position: "relative" }}>
            ...
            {repassword.length != 0 && pass != repassword && (
              <p className="text-[12px] m-0 text-red-400">this is not match</p>
            )}
          </div>
          ...
          <span className="text-sm text-gray-500 text-center m-2">
            Or Sign In Using
          </span>
          ...
          <div className="flex gap-2 justify-center items-center">
            ...
            <div className="flex items-center justify-center w-12 h-12   text-blue-800 bg-white rounded-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="fill-current cursor-pointer justify-center"
            ...
            <div className="flex items-center justify-center w-12 h-12 text-white bg-blue-400 rounded-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="fill-current p-2 cursor-pointer justify-center"
                width="40"
                height="40"
                fill="current"
                shapeRendering="geometricPrecision"
            ...
            <div className="flex items-center justify-center w-12 h-12 text-white bg-red-700 rounded-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="fill-current cursor-pointer p-[12px] justify-center"
                width="78"
                height="78"
                fill="current"
                shapeRendering="geometricPrecision"
          ...
          <div className="text-sm text-gray-500 text-center my-12 mb-2">
            Or Sign In Using
          </div>
          <button
